...
<div class="flex flex-col  w-full ">
            <div class="mb-4">
              <h2 class="font-bold text-lg mb-1">Register</h2>
              <p class="text-gray-400 ">Get Started Today, Create Your Account</p>
            </div>
            <!-- indicator -->
            ...
            <div class="mb-2 flex flex-col w-full">
              <label for="registername" class="font-semibold  mb-1">Name</label>
              <input id="registername" type="text" class="py-2" v-model="name"/>
            </div>
            <div class="mb-4 flex flex-col w-full">
              <label for="registersurname" class="font-semibold mb-1">Surname</label>
            ...
            <div v-show="page == 1">
            <div class="mb-2 flex flex-col w-full">
              <label for="registeremail" class="font-semibold mb-1">Email</label>
              <input id="registeremail" type="email" class="py-2" v-model="email"/>
            </div>
            <div class="mb-4 flex flex-col w-full">
              <label for="registersurwebsite" class="font-semibold mb-1">Website</label>
            ...
            <div v-show="page == 2">
            <div class="mb-2 flex flex-col w-full">
              <label for="registertel" class="font-semibold mb-1">Phone</label>
              <input id="registertel" type="tel" class="py-2" v-model="phone"/>
            </div>
            <div class="mb-4 flex flex-col w-full">
              <label for="registeruser" class="font-semibold mb-1">Number of users</label>
            ...
            <div v-show="page == 3">
            <div class="mb-2 flex flex-col w-full">
              <label for="registerpass" class="font-semibold mb-1">Password</label>
            ...
            <div class="mb-4 flex flex-col w-full">
              <label for="registerpass" class="font-semibold mb-1">Code sent via email</label>
            ...
            <div class="flex">
              ...
              <button @click="next()" class="bg-blue-800 text-white py-3 rounded-lg w-full flex flex-row justify-center align-middle">Next<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-white"> <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25 21 12m0 0-3.75 3.75M21 12H3" /> </svg></button>
            </div>
