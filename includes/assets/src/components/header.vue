  ...
  <div class="w-full bg-blue-800">
    <div class="  max-w-5xl mx-auto md:py-8 py-5 flex flex-row justify-between items-center">
      <div>
        ...
        <span class="text-white font-medium bg-blue-900 rounded px-2 py-1">{{$t('subHeading')}}</span>
      </div>
      <div class="flex flex-row items-center ">
        <a href="#" target="_blank" class="bg-blue-600 rounded text-white px-4 py-1 mr-2 text-sm font-semibold cursor-pointer hover:text-white hover:bg-blue-500 hover:shadow-sm">
